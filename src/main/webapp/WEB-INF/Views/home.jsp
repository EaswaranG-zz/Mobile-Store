	...
	<div>
		...
		<nav class="navbar navbar-expand bg-dark navbar-dark sticky-top">
			...
			<div class="mx-auto order-0">
				<a class="navbar-brand " href="#"> <img src="Easwar_logo.png"
					...
					<div id="demo" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="Apple_iphone_11.jpg" alt="Samsung Galaxy" width="1100"
									height="50">
							...
							<div class="carousel-item">
								<img src="oneplus_7.jpg" alt="One Plus" width="1100" height="50">
								<div class="carousel-caption">
									<h3>One Plus</h3>
							...
							<div class="carousel-item">
								<img src="Samsung_Note10.png" alt="Apple iPhone" width="1100"
									height="50">
		...
		<div class="container mt-3">
			...
			<div class="media border p-3">
				<img src="user-avatar.png" alt="Steve"
